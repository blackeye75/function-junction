...
export default function App() {
  return (
    <footer className="bg-zinc-950 text-center text-neutral-600  dark:text-neutral-200 lg:text-left">
      ...
      {/* <!--Copyright section--> */}
      <div className="bg-neutral-200 p-1 border-t-[1px] text-center dark:bg-zinc-950">
